...
<form method="POST" action="shorten.php" name="shortenUrl" id="unAuthShortenForm">
<fieldset class="cf">
<input id="txturl" taborder="1" name="url" oninput="OnInput (event)" type="text" class="shorten-input" placeholder="Paste a link to shorten it" value="" autocomplete="off" autocorrect="off" autocapitalize="off" required>
